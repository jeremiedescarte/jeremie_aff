...
const profils = [
  {
    ...
    color: "#00abf0",
    icon: "bx bx-code-alt",
    fichier: "/cv/cv-fullstackAFFODO.pdf",
  ...
  },
  {
  ...
  },
   {
    ...
    color: "#7919ef",
    icon: "bx bx-home-alt",
    fichier: "/cv/cv-academiqueAFFODO.pdf",
    competences: ["ALgorithme","Langages", "Mathematiques", "Virtualisation", "Linux", "Gestion serveurs", "Maintenance"],
  },
  {
    key: "gerant",
    color: "#059669",

...
const categories = [
  {
    ...
    skills: [
      ...
      { name: "API REST",          niveau: 70, icon: "bx-transfer" },
      { name: "Responsive Design", niveau: 85, icon: "bx-devices" },
      { name: "UI/UX Design",      niveau: 65, icon: "bx-palette" },
    ],
    techs: [
  ...
  },
  {
    ...
    color: "#7c3aed",
    skills: [
      { name: "MySQL",                      niveau: 80, icon: "bx-data" },
      { name: "Oracle Database",            niveau: 70, icon: "bx-cylinder" },
      { name: "SQL",                        niveau: 80, icon: "bx-code-curly" },
      { name: "Modélisation BDD",           niveau: 75, icon: "bx-sitemap" },
      { name: "Analyse de données",         niveau: 65, icon: "bx-bar-chart-alt-2" },
      { name: "Visualisation de données",   niveau: 60, icon: "bx-line-chart" },
      { name: "Data Science",               niveau: 60, icon: "bx-brain" },
    ],
    techs: [
  ...
  },
  {
    ...
    color: "#059669",
    skills: [
      { name: "Machine Learning",          niveau: 60, icon: "bx-chip" },
      { name: "Intelligence Artificielle", niveau: 55, icon: "bx-bot" },
      { name: "Analyse prédictive",        niveau: 55, icon: "bx-trending-up" },
      { name: "Prétraitement des données", niveau: 65, icon: "bx-filter-alt" },
      { name: "Algorithmes classification",niveau: 55, icon: "bx-category" },
      { name: "Réseaux de neurones",       niveau: 45, icon: "bx-network-chart" },
    ],
    techs: [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Architecture TCP/IP",    niveau: 70, icon: "bx-sitemap" },
      { name: "Analyse réseau",         niveau: 70, icon: "bx-search-alt" },
      { name: "Cybersécurité",          niveau: 65, icon: "bx-shield-alt-2" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Configuration DHCP",         niveau: 65, icon: "bx-wifi" },
      { name: "Configuration DNS",          niveau: 65, icon: "bx-globe" },
      { name: "Maintenance système",        niveau: 70, icon: "bx-wrench" },
      { name: "Virtualisation",             niveau: 70, icon: "bx-cube-alt" },
  ...
  },
  {
    ...
    color: "#0891b2",
    skills: [
      { name: "UML",                     niveau: 75, icon: "bx-sitemap" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Diagramme de Gantt", niveau: 70, icon: "bx-bar-chart-square" },
      { name: "Méthode PERT",       niveau: 65, icon: "bx-git-branch" },

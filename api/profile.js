  ...
  education: [
    {
      ...
      options: "Administration des Systèmes & Réseaux | Data Science & Systèmes d'Information",
      school: "École Supérieure de Management Télécommunication et Informatique (SUP MTI)",
      location: "Béni Mellal, Maroc",
      year: "Sept 2025 — Juin 2026"
    },
    {
      degree: "Licence — Ingénierie du Système Informatique",
      school: "École Supérieure de Management Télécommunication et Informatique (SUP MTI)",
      location: "Béni Mellal, Maroc",
    ...
    },
    {
      ...
      school: "Lycée Moderne de Bangolo",
      location: "Bangolo, Côte d'Ivoire",
      year: "Sept 2021 — Juillet 2022"
    }
  ],
  experience: [
    {
      role: "Stagiaire en Développement Informatique",
      company: "US2I — Univers Systèmes d'Information et Informatique",
      location: "Béni Mellal, Maroc",
      year: "2025",
      duration: "3 mois",
      tasks: [
        ...
        "Tests, correction de bugs et optimisation des performances",
  ...
  projects: [
    {
      ...
      description: "Réseau social pour étudiants avec gestion des posts, commentaires et planning",
      skills: ["Full-stack development", "API REST", "Base de données", "Analyse des besoins"]
    },
    {
      name: "SUPMTI Connect",
